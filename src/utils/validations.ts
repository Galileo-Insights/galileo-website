...
export const customFieldLevelValidation = (
  value: string,
  validations: Array<(val: string) => any>
): string | undefined => {
...
export const requiredSelect = (value: Array<string> | string): string | undefined => {
...
export const isDecimalNumer = (value: string): string | undefined =>
  value && !/^(\d+\.?\d*|\.\d+)$/.test(value) ? 'Only numbers and decimal places' : undefined;

export const isAlphaNumeric = (value: string): string | undefined =>
...
export const isValidPassword = (value: string): string | undefined => {
...
export const isDollarAmount = (value: string): string | undefined => {
...
export const requiredEmail = (value: string): string | undefined =>
  customFieldLevelValidation(value, [requiredField, isEmail]);

export const requiredPhoneNumber = (value: string): string | undefined =>
  customFieldLevelValidation(value, [requiredField, isPhoneNumber]);

export const requiredPassword = (value: string): string | undefined =>
...
export const requiredDollarAmount = (value: string): string | undefined =>
