...
const goldenrodLight = '#f3e4bc';
// const goldenrodDark = '#463304';

// rgba(0, 8, 31, 1)

// Secondary
const downriver = '#040f31'; // '#0E3757';
...
export const brandPrimary = goldenrod;
export const brandPrimaryHover = goldenrodLight;
...
// Typography
export const textColor = goldenrodLight;
export const textColorLight = lightGray;
export const headingsColor = goldenrod;
